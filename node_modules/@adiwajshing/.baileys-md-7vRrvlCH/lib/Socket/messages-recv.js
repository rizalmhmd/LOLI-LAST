...
const makeMessagesRecvSocket = (config) => {
        ...
        if (node.attrs.type === 'w:gp2') {
            switch (child === null || child === void 0 ? void 0 : child.tag) {
                case 'create':
                    ...
                    result.key = {
                        participant: (0, WABinary_1.jidNormalizedUser)(metadata.owner)
                    };
    ...
    const handleReceipt = async (node) => {
        ...
        if (typeof status !== 'undefined' && !(0, WABinary_1.areJidsSameUser)(attrs.from, (_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.id)) {
            const ids = [attrs.id];
